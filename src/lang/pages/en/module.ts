export default {
	...
	// buy
	'Module installation warning': 'Free download and update within one year after purchase. Virtual products do not support 7-day refund without reason',
	...
	no: 'no',
	// confirmFileConflict
	'Update warning': 'The following module files have been detected to be updated. When disabled, they will be automatically overwritten. Please pay attention to backup.',
	...
	'You need to disable this module before updating Do you want to disable it now?': 'You need to disable this module before updating. Do you want to disable it now?',
