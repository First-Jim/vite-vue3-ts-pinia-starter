export default {
  ...
  'stateTitle wait-full-reload':
    'Web side file updated, waiting for hot reload...',
  ...
  'My module': 'My module',
  'Log in to the buildadmin module marketplace':
    'Log in to the buildadmin module marketplace',
  'Please enter buildadmin account name or email':
    'Please enter buildadmin account name / email / mobile number',
  'Please enter the buildadmin account password':
    'Please enter the buildadmin account password',
  'Sign in': 'Sign in',
  'Please enter the login verification code':
    'Please enter the login verification code',
  ...
  'Dependency recovery warning 1':
    'After disabling, the system dependencies will be restored to the module ',
  'Dependency recovery warning 2': 'before installation',
  'Dependency recovery warning 3': ' Please pay attention to backup!',
  'composer and package The JSON file will be restored':
    'composer. JSON and Web / package The JSON file will be restored',
