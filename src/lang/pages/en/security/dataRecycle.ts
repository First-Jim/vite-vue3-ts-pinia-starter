export default {
	...
	'The data collection mechanism will monitor delete operations under this controller': 'The data recycle mechanism will monitor the delete operations under this controller.',
