export default {
	...
	'English name, which does not need to start with `/admin`, such as auth/menu': 'The English name does not need to start with `/admin`, such as: auth/menu.',
	...
	'extend Title': "For example, if 'auth/menu' is only added as a route, then `auth/menu`, `auth/menu/:a` and `auth/menu/:b/:c` can be added only as menus.",
	none: 'None',
};
