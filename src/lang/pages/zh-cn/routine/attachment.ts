export default {
	...
	'mime type': 'mime类型',
	'SHA1 code': 'sha1',
	'The file is saved in the directory, and the file will not be automatically transferred if the record is modified': '文件保存目录，修改记录不会自动转移文件',
	...
	'When the same file is uploaded multiple times, only one attachment record will be saved and added': '同一文件被多次上传时，只会保存一份和增加一条附件记录',
