              ...
              >
                ...
                >
                  <el-input
                    ...
                    :placeholder="
                      t('Please input field', { field: t('user.user.mailbox') })
                    "
                    :clearable="true"
                    size="large"
                  >
        ...
        >
          <el-form-item :label="t('user.user.Retrieval method')">
            <el-radio-group v-model="state.retrievePasswordForm.type">
              ...
              <el-radio
                ...
                border
                >{{ t('user.user.Via mobile number') }}</el-radio
              >
            </el-radio-group>
          </el-form-item>
          <el-form-item
          ...
          <el-form-item prop="password" :label="t('user.user.New password')">
            <el-input
              ...
              :placeholder="
                t('Please input field', { field: t('user.user.New password') })
              "
              show-password
            >
              <template #prefix>
  ...
  formRef!.validateField('account').then((valid) => {
    if (valid) {
      ...
      sendRetrievePasswordCode(
        ...
        state.retrievePasswordForm.account,
      )
        .then((res) => {
          state.sendCaptchaLoading = false;
          if (res.code == 1) {
