					...
					<div class="content">
						<el-form @keyup.enter="onSubmit(formRef)" ref="formRef" :rules="rules" size="large" :model="form">
							<el-form-item prop="username">
								<el-input ref="usernameRef" type="text" clearable v-model="form.username" :placeholder="t('adminLogin.Please enter an account')">
									<template #prefix>
							...
							<el-form-item prop="password">
								<el-input ref="passwordRef" v-model="form.password" type="password" :placeholder="t('adminLogin.Please input a password')" show-password>
									<template #prefix>
							...
							<el-form-item v-if="state.showCaptcha" prop="captcha">
								<el-row class="w100" :gutter="15">
									<el-col :span="16">
										<el-input ref="captchaRef" type="text" :placeholder="t('adminLogin.Please enter the verification code')" v-model="form.captcha" clearable autocomplete="off">
											<template #prefix>
