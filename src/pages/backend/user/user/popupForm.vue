			...
			<div class="ba-operate-form" :class="'ba-' + baTable.form.operate + '-form'" :style="'width: calc(100% - ' + baTable.form.labelWidth! / 2 + 'px)'">
				...
				>
					...
					<el-form-item prop="nickname" :label="t('user.user.nickname')">
						<el-input v-model="baTable.form.items!.nickname" type="string" :placeholder="t('Please input field', { field: t('user.user.nickname') })"></el-input>
					</el-form-item>
					<FormItem
						type="remoteSelect"
					...
					<el-form-item prop="email" :label="t('user.user.mailbox')">
						<el-input v-model="baTable.form.items!.email" type="string" :placeholder="t('Please input field', { field: t('user.user.mailbox') })"></el-input>
					</el-form-item>
					<el-form-item prop="mobile" :label="t('user.user.mobile')">
						<el-input v-model="baTable.form.items!.mobile" type="string" :placeholder="t('Please input field', { field: t('user.user.mobile') })"></el-input>
					</el-form-item>
					<FormItem
					...
					<el-form-item prop="password" :label="t('user.user.password')">
						<el-input
							...
							type="password"
							:placeholder="baTable.form.operate == 'add' ? t('Please input field', { field: t('user.user.password') }) : t('user.user.Please leave blank if not modified')"
						></el-input>
					</el-form-item>
